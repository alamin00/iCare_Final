...
public class prescription_List2 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prescription__list2);
        ...
        dataList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Intent intent = new Intent(prescription_List2.this,
                        showPrescription.class);
        ...
        addImage = (Button) findViewById(R.id.btnAddprescription);
