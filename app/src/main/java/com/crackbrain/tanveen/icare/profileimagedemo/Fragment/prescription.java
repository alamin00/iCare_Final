...
public class prescription extends Fragment {
    ...
    public static prescription newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.prescription_add, container, false);

        final Button btnPrescription = (Button)view.findViewById(R.id.btnaddprescription);
